...
public class BestSell_Model {
    ...
    public BestSell_Model(String prod_id,String prod_name,String img_url,String old_price,String price,String rating){
...
this.rating = rating;
    ...
    public void setProd_id(String name){this.prod_id = name;}
